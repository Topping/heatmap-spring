...
public class SamplePump implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(final ApplicationReadyEvent event) {
        ...
        try {
            ...
            heatmaps.add(new Heatmap(sample.getName() + " (Sample)", sample.getLastModified(), sample.getRangeStart(), sample.getRangeEnd(), sample.getPolylines())); // To get autogenerated heatmap
